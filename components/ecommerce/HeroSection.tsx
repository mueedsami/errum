  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-40 top-0 h-[500px] w-[500px] rounded-full opacity-[0.07]"
             style={{ background: `radial-gradient(circle, var(--gold) 0%, transparent 70%)`, transition: 'all 1.2s ease' }} />
