        ...
        <div className="ec-container">
          <div className="ec-surface p-5 sm:p-7">
            <div className="mb-6 space-y-2">
              <div className="h-2.5 w-28 rounded-full bg-neutral-200 animate-pulse" />
              <div className="h-9 w-52 rounded-lg bg-neutral-200 animate-pulse" />
            </div>
            <div className="grid grid-cols-3 gap-3 sm:grid-cols-5">
              {Array.from({ length: 10 }).map((_, i) => (
                <div key={i} className="animate-pulse">
                  <div className="aspect-[3/4] rounded-2xl bg-neutral-100 mb-2" />
                  <div className="h-3 rounded-full bg-neutral-100 w-3/4 mx-auto" />
                </div>
              ))}
            </div>
          </div>
